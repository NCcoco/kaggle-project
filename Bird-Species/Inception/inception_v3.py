...
class InceptionV3(tf.keras.Model):
    def __init__(self, num_class, aux_logits=True):
        ...
        self.block_1 = tf.keras.Sequential([
            InceptionModule_1(filter_num=16),
        ...
        self.block_2 = tf.keras.Sequential([
            InceptionModule_2(),
            InceptionModule_3(filter_num=64),
            InceptionModule_3(filter_num=80),
            InceptionModule_3(filter_num=80),
            InceptionModule_3(filter_num=96),
        ])
        ...
        self.fc = tf.keras.layers.Dense(units=num_class, activation='softmax')
