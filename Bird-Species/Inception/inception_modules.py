...
class Preprocess(tf.keras.layers.Layer):
    def __init__(self):
        ...
        self.conv1 = BasicConv2D(filters=16,
                                 kernel_size=(3, 3),
                                 strides=1,
                                 padding="same")
        self.conv2 = BasicConv2D(filters=16,
                                 kernel_size=(3, 3),
                                 strides=1,
                                 padding="same")
        self.conv3 = BasicConv2D(filters=32,
                                 kernel_size=(3, 3),
                                 strides=1,
                                 padding="same")
        ...
        self.maxpool1 = tf.keras.layers.MaxPool2D(pool_size=(3, 3),
                                                  strides=2,
                                                  padding="same")
        self.conv4 = BasicConv2D(filters=40,
                                 kernel_size=(1, 1),
                                 strides=1,
                                 padding="same")
        self.conv5 = BasicConv2D(filters=96,
                                 kernel_size=(3, 3),
                                 strides=1,
                                 padding="same")
...
class InceptionModule_1(tf.keras.layers.Layer):
    def __init__(self, filter_num):
        ...
        # branch 0
        self.conv_b0_1 = BasicConv2D(filters=32,
                                     kernel_size=(1, 1),
                                     strides=1,
                                     padding="same")

        # branch 1
        self.conv_b1_1 = BasicConv2D(filters=24,
                                     kernel_size=(1, 1),
                                     strides=1,
                                     padding="same")

        self.conv_b1_2 = BasicConv2D(filters=32,
                                     kernel_size=(5, 5),
                                     strides=1,
                                     padding="same")

        # branch 2
        self.conv_b2_1 = BasicConv2D(filters=32,
                                     kernel_size=(1, 1),
                                     strides=1,
                                     padding="same")

        self.conv_b2_2 = BasicConv2D(filters=48,
                                     kernel_size=(3, 3),
                                     strides=1,
                                     padding="same")
        self.conv_b2_3 = BasicConv2D(filters=48,
                                     kernel_size=(3, 3),
                                     strides=1,
                                     padding="same")
...
class InceptionModule_2(tf.keras.layers.Layer):
    def __init__(self):
        ...
        # branch 0
        self.conv_b0_1 = BasicConv2D(filters=96,
                                     kernel_size=(3, 3),
                                     strides=2,
                                     padding="valid")

        # branch 1
        self.conv_b1_1 = BasicConv2D(filters=32,
                                     kernel_size=(1, 1),
                                     strides=1,
                                     padding="same")
        self.conv_b1_2 = BasicConv2D(filters=48,
                                     kernel_size=(3, 3),
                                     strides=1,
                                     padding="same")
        self.conv_b1_3 = BasicConv2D(filters=48,
                                     kernel_size=(3, 3),
                                     strides=2,
                                     padding="valid")
...
class InceptionModule_3(tf.keras.layers.Layer):
    def __init__(self, filter_num):
        ...
        self.conv_b2_4 = BasicConv2D(filters=filter_num,
                                     ...
                                     strides=1,
                                     padding="same")
        self.conv_b2_5 = BasicConv2D(filters=96,
                                     kernel_size=(1, 7),
                                     strides=1,
                                     padding="same")
        ...
        self.avgpool_b3_1 = tf.keras.layers.MaxPool2D(pool_size=(3, 3),
                                                      strides=1,
                                                      padding="same")
        self.conv_b3_2 = BasicConv2D(filters=96,
                                     kernel_size=(1, 1),
                                     strides=1,
                                     padding="same")
...
class InceptionModule_4(tf.keras.layers.Layer):
    def __init__(self):
        ...
        self.conv_b0_1 = BasicConv2D(filters=96,
                                     ...
                                     strides=1,
                                     padding="same")
        self.conv_b0_2 = BasicConv2D(filters=160,
                                     kernel_size=(3, 3),
                                     strides=2,
                                     padding="valid")

        # branch 1
        self.conv_b1_1 = BasicConv2D(filters=96,
                                     kernel_size=(1, 1),
                                     strides=1,
                                     padding="same")
        ...
        self.conv_b1_4 = BasicConv2D(filters=96,
                                     kernel_size=(3, 3),
                                     strides=2,
                                     padding="valid")
...
class InceptionModule_5(tf.keras.layers.Layer):
    def __init__(self):
        ...
        self.conv1 = BasicConv2D(filters=160,
                                 kernel_size=(1, 1),
                                 strides=1,
                                 padding="same")
        self.conv2 = BasicConv2D(filters=192,
                                 kernel_size=(1, 1),
                                 strides=1,
                                 padding="same")
        self.conv3 = BasicConv2D(filters=224,
                                 kernel_size=(1, 1),
                                 strides=1,
                                 padding="same")
        self.conv4 = BasicConv2D(filters=192,
                                 kernel_size=(1, 3),
                                 strides=1,
                                 padding="same")
        self.conv5 = BasicConv2D(filters=192,
                                 ...
                                 strides=1,
                                 padding="same")
        self.conv6 = BasicConv2D(filters=192,
                                 kernel_size=(3, 3),
                                 strides=1,
                                 padding="same")
        self.conv7 = BasicConv2D(filters=96,
                                 kernel_size=(1, 1),
                                 strides=1,
                                 padding="same")
