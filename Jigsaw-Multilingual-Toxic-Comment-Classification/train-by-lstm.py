...
# embedding_index = {}
#
# embedding_matrix = np.zeros(shape=(len(word_index), 300))
...
with strategy.scope():
    model = keras.Sequential([
        ...
        Embedding(len(word_index) + 1, 300, input_length=max_len),
...
model.fit(x_train_pad, y_train, batch_size=64, epochs=3)
